...
import {ServerUrl,DoctorAdd} from "./Constants";
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                axios.post(ServerUrl + DoctorAdd, {
                    name: values.name,
                    age: values.age,
        ...
        return (
            <div>
                <Form onSubmit={this.handleSubmit}>
                    ...
                    >
                        {
                            getFieldDecorator('exprience')(<Input maxLength={200} placeholder={'请输入您的从医经历'}/>)
                        }
                    ...
                    >
                        {
                            getFieldDecorator('hospitalCode', {
                                rules: [{required: true, message: '请输入您的就职医院编码'}]
                            })(<Input placeholder={'请输入您的就职医院编码(必填)'}/>)
                        }
                    </Item>
                    <Item {...formItemLayout}
                          label={'就职科室编码'}
                    ...
                    >
                        {
                            getFieldDecorator('departmentCode', {
                                rules: [{required: true, message: '请输入您的就职科室编码'}]
                            })(<Input placeholder={'请输入您的就职科室编码(必填)'}/>)
                        }
                    </Item>
                    <Item {...formItemLayout}
                          label={'医生级别'}
                    ...
                    >
                        {
                            getFieldDecorator('level', {
                                rules: [{required: true, message: '请输入您的医生级别'}]
                            })(<Input placeholder={'请输入您的医生级别(必填)'}/>)
                        }
                    </Item>
                    <Item {...tailItemLayout}>
                        {
